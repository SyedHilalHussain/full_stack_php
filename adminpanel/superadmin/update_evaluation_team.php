...
$q_e = mysqli_query($conn,"select * from tbl_judge_assessment where user_id = $user_id and team_id = $team_id");
...
$youtube_id = $match[1];
    ...
    $e_id = $_GET['team_id'];
    // $name=$_SESSION['name'];
    $q_e = mysqli_query($conn,"select * from tbl_judge_assessment where id = $e_id");
    $d_e = mysqli_fetch_assoc($q_e);
    $team= $d_e['team_id'];
    $v_q = mysqli_query($conn,"select * from tbl_team where id = $team");
    $v_d = mysqli_fetch_assoc($v_q);
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="evaluation_team_update">
