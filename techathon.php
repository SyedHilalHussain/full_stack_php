...
<!-- banner code -->
  ...
  <section class="main main-body-work">
    <div class="emuinvent about-container mt-5 ">
      ...
      <div class="cl-xl-7 col-lg-12 col-md-10 col-sm-12">
        ...
        <div class="section-tittle text-center mb-70">
          ...
          <div class="row mt-5 ">
            ...
            <div class="col-lg-2 poster-center-div" ></div>
            <div class="col-lg-5  ">
...
<p>Parents can act as a mentor and may register the student/team by signing up to the <b style="color:#ffffff;">EMUiNVENT</b> site as "Mentor".&nbsp;</p>
    ...
    <div class="col-lg-3 col-12  about-us-register-btn justify-content-center align-items-center"><a href="register.php"><button type="button"  class="btn" >Register Now</button></a></div> 
